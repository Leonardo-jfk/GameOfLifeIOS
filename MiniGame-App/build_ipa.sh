...
# À placer dans /Users/yaroslavyakovlev/ACoding/coding 2025/projects/GameOfLifeIOS/GameOfLifeIOS/
...
if [ -f "../build/GameOfLifeIOS.ipa" ]; then
    echo ""
    echo "✅ SUCCÈS!"
    echo "IPA: $(cd .. && pwd)/build/GameOfLifeIOS.ipa"
    echo "Taille: $(du -h ../build/GameOfLifeIOS.ipa | cut -f1)"
    echo ""
    echo "📱 Installation avec AltStore:"
    echo "   1. Transférez le fichier sur iPhone"
    echo "   2. Ouvrez AltStore → My Apps → +"
    echo "   3. Sélectionnez GameOfLifeIOS.ipa"
    echo ""
    open ../build
else
    echo ""
